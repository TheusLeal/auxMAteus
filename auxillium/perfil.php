<?php
   ...
   $nome_temporario=$_FILES["uploaded_file"]["tmp_name"]; //PEGA O DIRETORIO ORIGINAL
   $nome_real=$_FILES["uploaded_file"]["name"]; //PEGA O NOME DA IMAGEM
   copy($nome_temporario,"FotoPerfil/$nome_real"); //COPIA PARA UM NOVO DIRETORIO
   rename ("FotoPerfil/$nome_real" , "FotoPerfil/$username.png" ); //
?>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="FotoPerfil/<?=$username?>.png" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="todo_list.html">Lista de afazeres</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="lock_screen.html">Bloquear tela</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          <i class="fa fa-th"></i>
                          <span>Tabela de informaçoes</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="basic_table.html">Abrir tabela</a></li>
